package test.plugin.com.cameralibrary.camera;
...
import test.plugin.com.cameralibrary.R;
import test.plugin.com.cameralibrary.cropper.CropImageView;
import test.plugin.com.cameralibrary.cropper.CropListener;
import test.plugin.com.cameralibrary.global.Constant;
import test.plugin.com.cameralibrary.utils.CommonUtils;
import test.plugin.com.cameralibrary.utils.FileUtils;
import test.plugin.com.cameralibrary.utils.ImageUtils;
import test.plugin.com.cameralibrary.utils.PermissionUtils;
import test.plugin.com.cameralibrary.utils.ScreenUtils;
    ...
    private void confirm() {
        ...
        mCropImageView.crop(new CropListener() {
            ...
            public void onFinish(Bitmap bitmap) {
                ...
                /*保存图片到sdcard并返回图片路径 createOrExistsDir(Constant.DIR_ROOT)*/
                if (FileUtils.creatOrExistsDir(Constant.DIR_ROOT)) {
